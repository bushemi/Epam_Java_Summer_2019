...
public class TestForSessionDto {
    ...
    public TestForSessionDto(Long id, Long subjectId, String testName,
                             Integer difficulty, Integer secondsToComplete,
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), that.getId()) &&
                ...
                Objects.equals(getQuestionsQuantity(), that.getQuestionsQuantity());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getSubjectId(), getTestName(), getDifficulty(), getSecondsToComplete(), getQuestionsQuantity());
    }
